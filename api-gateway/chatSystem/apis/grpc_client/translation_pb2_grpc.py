...
class TranslationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TranslateText = channel.unary_unary(
                ...
                request_serializer=translation__pb2.TextRequest.SerializeToString,
                response_deserializer=translation__pb2.TextResponse.FromString,
...
def add_TranslationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TranslateText': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=translation__pb2.TextRequest.FromString,
                    response_serializer=translation__pb2.TextResponse.SerializeToString,
            ),
    }
...
class TranslationService(object):
    ...
    def TranslateText(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/translation.TranslationService/TranslateText',
            translation__pb2.TextRequest.SerializeToString,
            translation__pb2.TextResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
